...
data <- read_excel("/Users/julia/Desktop/Git/EEGfMRIStudy/UnconsciousBias/data/BackwardMask_Questionnaire_Results.xlsx", 
                 col_types = c("text", 
...
results <- results %>%
  mutate(across(c(P_Value, T_Value, Cohens_D, SE, Bonferroni_Corrected_P), ~round(., 5)))

# Display the results
print(results)
write.csv(results, "/Users/julia/Desktop/Git/EEGfMRIStudy/UnconsciousBias/data/Group_Comparison_Questionnaires.csv", row.names = FALSE)
```
