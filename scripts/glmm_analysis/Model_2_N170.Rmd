...
con_in_group <-   afex_plot(Model, x = "consciousness", panel = "group", 
            id = "name", dodge = 0.8,
...
ggsave("W:/Fmri_Forschung/Allerlei/JuliaS/Paper/2024_EEGfMRi/BiologicalPsychiatrySubmission/Revision2/Plots/GLMM_N170.tiff", combined_plots, width = 6, height = 7)
```
