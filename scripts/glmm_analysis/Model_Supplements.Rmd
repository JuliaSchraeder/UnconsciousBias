...
Model 5:Test if medication has an effect on N170 values

```{r}
data <- read_excel("/Users/julia/Desktop/Git/EEGfMRIStudy/data/BackwardMask_Mean_RT_Long_MDD_On_vs_Off_Medication.xlsx", 
